...
process.source = cms.Source("PoolSource",
    ...
    '/store/relval/CMSSW_7_0_0_pre9/MinimumBias/RECO/PRE_62_V8_RelVal_mb2012B-v4//00000/0EADE2B6-4A5D-E311-9613-0025905A6092.root',
    )
)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('EcalValidation_7.root')
)
