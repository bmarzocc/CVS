...
process.source = cms.Source("PoolSource",
    ...
    '/store/relval/CMSSW_7_0_0_pre9/MinimumBias/RECO/PRE_62_V8_RelVal_mb2012B-v4//00000/02BF8C7F-405D-E311-B679-0025905A6118.root',
    )
)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('EcalValidation_2.root')
)
