...
process.source = cms.Source("PoolSource",
    ...
    '/store/relval/CMSSW_7_0_0_pre9/MinimumBias/RECO/PRE_62_V8_RelVal_mb2012B-v4//00000/D0A45DF5-4A5D-E311-814D-0025905A608E.root',
    )
)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('EcalValidation_81.root')
)
