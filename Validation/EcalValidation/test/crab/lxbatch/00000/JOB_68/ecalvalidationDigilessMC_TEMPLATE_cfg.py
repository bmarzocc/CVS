...
process.source = cms.Source("PoolSource",
    ...
    '/store/relval/CMSSW_7_0_0_pre9/MinimumBias/RECO/PRE_62_V8_RelVal_mb2012B-v4//00000/B025A655-505D-E311-952A-0025905A48BA.root',
    )
)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('EcalValidation_68.root')
)
