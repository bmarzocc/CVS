...
process.source = cms.Source("PoolSource",
    ...
    '/store/relval/CMSSW_7_0_0_pre9/MinimumBias/RECO/PRE_62_V8_RelVal_mb2012B-v4//00000/3CDB0198-435D-E311-8D7A-0025905A605E.root',
    )
)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('EcalValidation_22.root')
)
